<script lang="ts">
	// Iconos vectoriales propios (sin emojis). Trazo de 24x24, hereda currentColor.
	let {
		name,
		size = 16,
		stroke = 2,
...
>
	...
	{:else if name === 'wrench'}
		<path
			d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18v3h3l6.3-6.3a4 4 0 0 0 5.4-5.4l-2.5 2.5-2.3-2.3 2.8-2.7z"
		/>
	{:else if name === 'clock'}
	...
	{:else if name === 'key'}
		...
		<path d="M11.4 11.6 21 2M16 7l3 3" />
	{:else if name === 'user'}
